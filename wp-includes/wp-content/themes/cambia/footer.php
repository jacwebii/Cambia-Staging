...
<?php if(!is_front_page()) { ?>
	...
	<section id="cambia-business">
		<div class="container">
			...
			<li><a href="<?php echo home_url();?>/pivotal-briefs/" class="col-md-12 green-btn">Case Study</a></li>
			...
			<div class="row">
				<div>
					...
					<p class="copyright-text">
						<img src="https://www.webii.net/cambia/wp-content/uploads/2018/06/logo-esomar.png" alt="ESOMAR Member" style="float:left;padding:5px;" />As an ESOMAR Member, I comply with the <a href="http://www.esomar.org/knowledge-and-standards/codes-and-guidelines.php" target="_blank"></a>ICC/ESOMAR Code on Market and Social Research and ESOMAR World Research Guidelines</a>.
					Cambia Information Group is committed to GDPR compliance, and we provide GDPR related assurances in our contractual commitments.
				</p>
				</div>
